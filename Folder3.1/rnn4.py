...
data = urllib.request.urlopen(
    "http://www.gutenberg.org/cache/epub/1778/pg1778.txt")
text = data.read().decode(encoding='utf-8')
text = text[10717:-619]
'''DATA'''
# text = open('proverbs.txt', 'rb').read().decode(encoding='utf-8')
...
print(generate_text(model, start_string=u"Proverbs "))
